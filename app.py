        ...
        try:
            with st.spinner("Waiting..."):
                ...
                if "youtube.com" in generic_url:
                    loader=YoutubeLoader.from_youtube_url(generic_url,add_video_info=True,language=['en','fr','ar'],transcript_format=TranscriptFormat.CHUNKS,chunk_size_seconds=30,)
                else:
